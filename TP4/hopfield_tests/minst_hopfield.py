...
if __name__ == "__main__":
    ...
    # Aplicar PCA
    n_components = 100  # Ajusta según tus necesidades
    ...
    indices = []
    amount_of_digits_in_patterns = 2
    for i in range(4):
    ...
    # Recuperar el patrón
    recovered_pattern, states_history, energies = hopfield_net.get_similar(test_pattern.copy(), 100)
    ...
    # Asegurar que los valores estén en el rango correcto
    retrieved_pattern_descaled = np.clip(retrieved_pattern_descaled, 0, 255)
