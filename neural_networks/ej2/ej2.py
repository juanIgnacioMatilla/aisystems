...
from neural_networks.ej2.simple_perceptron_normalized_data import SimpleNonLinearPerceptron, SimpleLinearPerceptron
...
def main():  # Add k_folds parameter
...
if __name__ == "__main__":
    main()  # Specify the number of runs and k-folds
