...
from neural_networks.src.model.simple_perceptron.simple_nonlineal_perceptron import SimpleNonLinearPerceptron
from neural_networks.src.model.simple_perceptron.simple_lineal_perceptron_classifier import SimplePerceptronClassifier
